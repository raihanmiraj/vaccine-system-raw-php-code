        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content rounded-5 shadow">
            <div class="modal-header p-5 pb-4 border-bottom-0">
              ...
              <h2 class="fw-bold mb-0">Nurse Login</h2>
...
<?php
                ...
                <div class="form-floating mb-3">
                  <input type="text" name="nid" class="form-control rounded-4" id="nid" placeholder="nid" required>
          ...
          <h2 class="fs-5 fw-bold mb-3">Or Login As</h2>
                <a class="w-100 py-2 mb-2 btn btn-outline-dark rounded-4"  href="adminlogin.php">
                    Admin
                </a>
